...
export function goalsFileHeader(date = todayStr()): string {
  ...
  return [
    ...
    '',
    '> Auto-saved from Multi-AgentOS dashboard. Update checkbox status here or in the app.',
    '',
    '---',
    '',
  ].join('\n')
...
export function chatFileHeader(date: string, agentName?: string): string {
  ...
  return [
    ...
    `# 🤖 ${title}`,
    '',
    `> Auto-saved from Multi-AgentOS dashboard · [[Multi-AgentOS]]`,
    '',
    '---',
    '',
  ].join('\n')
...
export function missionsFileHeader(): string {
  return [
    frontmatter('Multi-AgentOS — Missions', ['agentic-os', 'missions', 'goals']),
    '# 🎯 Multi-AgentOS — Mission Log',
    '',
    '> Tracks all missions deployed from the Multi-AgentOS dashboard.',
    '',
    '---',
    '',
  ].join('\n')
